...
#define MBED_CONF_APP_NUM_VOICES                                              8                                                                                                // set by application
#define MBED_CONF_APP_SAMPLE_RATE_HZ                                          48000                                                                                            // set by application
...
#define MBED_CONF_GR_PEACH_SYNTH_TARGET_BOARD                                 "GR-PEACH"                                                                                       // set by library:gr-peach-synth
